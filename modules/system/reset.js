...
module.exports = async function () {
    let sql = 'SET FOREIGN_KEY_CHECKS=0;TRUNCATE news;TRUNCATE student;TRUNCATE bysj;TRUNCATE kcsj;TRUNCATE scsx;TRUNCATE scsx_task;TRUNCATE scsx_report;SET FOREIGN_KEY_CHECKS=1';
