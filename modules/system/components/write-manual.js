export default {
    ...
    <div v-if="show" class="d-flex flex-column h-100">
        <nav class="nav nav-tabs nav-justified sticky-top bg-main">
            <a data-toggle="tab" class="nav-item nav-link active" href="#manual_editor"
                @click="identity='student'">学生</a>
            <a data-toggle="tab" class="nav-item nav-link" href="#manual_editor" @click="identity='teacher'">教师</a>
            <a data-toggle="tab" class="nav-item nav-link" href="#manual_editor" @click="identity='admin'">管理员</a>
        </nav>
