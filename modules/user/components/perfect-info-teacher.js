export default {
    ...
    <div class="app-container app-scroll row align-items-center justify-content-center">
        <form class="col-12 col-sm-9 col-md-8 col-lg-6 col-xl-5 text-center mt-3" @submit.prevent="submit">
            ...
            <input-text v-model="fields.homepage" label="个人主页" placeholder="请输入正确的网址，不超过255位字符" maxlength="255"></input-text>
            <input-text v-model="fields.office" label="办公地点" placeholder="不超过255个字符（或汉字）" maxlength="255"></input-text>
            </input-text>
            <input-text v-model="fields.field" label="研究领域" placeholder="不超过255个字符（或汉字）" maxlength="255"></input-text>
            </input-text>
